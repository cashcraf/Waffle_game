...
// refer to Module (if they choose; they can also define Module)
  ...
  (function() {
    ...
    var loadPackage = function(metadata) {
      ...
      var PACKAGE_NAME = 'waffleWeb.data';
...
Module['FS_createPath']("/", "Sounds", true, true);
      ...
      function processPackageData(arrayBuffer) {
        ...
        // Reuse the bytearray from the XHR as the source for file reads.
          ...
          }          Module['removeRunDependency']('datafile_waffleWeb.data');

      };
      Module['addRunDependency']('datafile_waffleWeb.data');
...
var ___start_em_js = Module['___start_em_js'] = 58120;
var ___stop_em_js = Module['___stop_em_js'] = 58193;
